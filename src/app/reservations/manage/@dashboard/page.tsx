  ...
  var createdAt = new Date(profile.data.createdAt);
    ...
    return (
      <main className="bg-slate-100 m-5 p-5">
        ...
        <table className="table-auto border-seperate boder-spacing-2"><tbody>
...

          {
            ...
            <form action={addCar}>
              ...
              <div className="flex items-center w-1/2 my-2">
                ...
                className="bg-whit border-2 border-gray-200 rounded w-full p-2
              ...
              <div className="flex items-center w-1/2 my-2">
                ...
                min={0} max={50}
                className="bg-whit border-2 border-gray-200 rounded w-auto p-2
                text-gray-700 focus:outline-none focus:border-blue-400"/>
